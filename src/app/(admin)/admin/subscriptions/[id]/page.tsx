...
import DetailSubscription from "@/app/(admin)/admin/subscriptions/[id]/components/detail-subscription";
import BackButton from "@/components/back-button";
import { Separator } from "@/components/ui/separator";

const AdminDetailSubscriptionPage = ({
  params: { id },
}: {
  params: {
    id: number;
...
export default AdminDetailSubscriptionPage;
