...
import { BookCopyIcon, DollarSignIcon, UserPlusIcon } from "lucide-react";
import { useRouter } from "next/navigation";
import { useEffect, useState } from "react";

import dashboardApi from "@/apis/dashboard.api";
import { Separator } from "@/components/ui/separator";
import { COURSE_STATUS, SUBSCRIPTION_STATUS } from "@/constants/enum";
...
const Overview = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      const {
        payload: { data },
      } = await dashboardApi.clientOverview();
