...
function genYears(limitToCurrent = false, yearRange = 50) {
...
function Calendar({
  ...
  yearRange = 50,
  limitToCurrent = false,
  ...props
}: CalendarProps & { yearRange?: number; limitToCurrent?: boolean }) {
  ...
  const YEARS = React.useMemo(() => genYears(limitToCurrent, yearRange), []);
